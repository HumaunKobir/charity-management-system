...
if(isset($_POST['save_student']))
{
    ...
    $query = "INSERT INTO found_tb (years,month_n,date_m,time_t,name_dita,money_d) VALUES ('$years','$months','$date','$time','$name','$email')";
...
if(isset($_POST['update_student']))
{
    ...
    $query = "UPDATE found_tb SET years='$years',month_n='$months',date_m='$date',time_t='$time', name_dita='$name', money_d='$email'
                WHERE id='$student_id'";
    $query_run = mysqli_query($con, $query);
