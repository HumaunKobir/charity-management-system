...
<?php
    $sqli="SELECT * FROM found_tb Where years='2026' AND month_n='October'";
    $result=mysqli_query($conn, $sqli);
    $query ="SELECT SUM(money_d) AS total_add FROM found_tb Where years='2026' AND month_n='October'";
    $query_result = mysqli_query($conn,$query);
  
?>
 
 <div class="mt-3">
 <h4>অক্টবার ২০২৬ আয় সমূহ</h4>
