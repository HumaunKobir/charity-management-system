...
<?php
    $sqli="SELECT * FROM found_tb Where years='2026' AND month_n='December'";
    $result=mysqli_query($conn, $sqli);
    $query ="SELECT SUM(money_d) AS total_add FROM found_tb Where years='2026' AND month_n='December'";
    $query_result = mysqli_query($conn,$query);
  
?>
 
 <div class="mt-3">
 <h4>ডিসেম্বার ২০২৬ আয় সমূহ</h4>
