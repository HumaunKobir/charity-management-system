...
<?php
    $sqli="SELECT * FROM expension_tb Where yearss='2022' AND months='November'";
    $result=mysqli_query($conn, $sqli);
    $query ="SELECT SUM(money_ex) AS total_ex FROM expension_tb Where yearss='2022' AND months='November'";
...
<div class="mt-3">
 <h4>নভেম্বার ২০২২ ব্যায় সমূহ</h3>
