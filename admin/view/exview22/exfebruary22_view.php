...
<?php
    $sqli="SELECT * FROM expension_tb Where yearss='2022' AND months='February'";
    $result=mysqli_query($conn, $sqli);
    $query ="SELECT SUM(money_ex) AS total_ex FROM expension_tb Where yearss='2022' AND months='February'";
...
<div class="mt-3">
 <h4>ফেব্রুয়ারী ২০২২ ব্যায় সমূহ</h3>
