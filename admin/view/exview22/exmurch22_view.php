...
<?php
    $sqli="SELECT * FROM expension_tb Where yearss='2022' AND months='March'";
    $result=mysqli_query($conn, $sqli);
    $query ="SELECT SUM(money_ex) AS total_ex FROM expension_tb Where yearss='2022' AND months='March'";
