...
<?php
    $sqli="SELECT * FROM expension_tb Where yearss='2024' AND months='September'";
    $result=mysqli_query($conn, $sqli);
    $query ="SELECT SUM(money_ex) AS total_ex FROM expension_tb Where yearss='2024' AND months='September'";
...
?>
 ...
 <div class="mt-4">
 <h4>সেপ্টেম্বার ২০২৪ ব্যায় সমূহ</h4>
