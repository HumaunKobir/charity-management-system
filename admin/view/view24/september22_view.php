...
<?php
    $sqli="SELECT * FROM found_tb Where years='2024' AND month_n='September'";
    $result=mysqli_query($conn, $sqli);
    $query ="SELECT SUM(money_d) AS total_add FROM found_tb Where years='2024' AND month_n='September'";
    $query_result = mysqli_query($conn,$query);
  
?>
 
 <div class="mt-3">
 <h4>সেপ্টেম্বার ২০২৪ আয় সমূহ</h4>
