...
<?php
    $sqli="SELECT * FROM expension_tb Where yearss='2026' AND months='January'";
    $result=mysqli_query($conn, $sqli);
    $query ="SELECT SUM(money_ex) AS total_ex FROM expension_tb Where yearss='2026' AND months='January'";
...
?>
 ...
 <div class="mt-3">
 <h4>জানুয়ারী ২০২৬ ব্যায় সমূহ</h4>
