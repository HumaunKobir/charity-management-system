...
<?php
    $sqli="SELECT * FROM found_tb Where years='2025' AND month_n='August'";
    $result=mysqli_query($conn, $sqli);
    $query ="SELECT SUM(money_d) AS total_add FROM found_tb Where years='2025' AND month_n='August'";
    $query_result = mysqli_query($conn,$query);
  
?>
 
 <div class="mt-3">
 <h4>আগষ্ট ২০২৫ আয় সমূহ</h4>
