...
<?php
    $sqli="SELECT * FROM found_tb Where years='2025' AND month_n='November'";
    $result=mysqli_query($conn, $sqli);
    $query ="SELECT SUM(money_d) AS total_add FROM found_tb Where years='2025' AND month_n='November'";
    $query_result = mysqli_query($conn,$query);
  
?>
 
 <div class="mt-3">
 <h4>নভেম্বার ২০২৫ আয় সমূহ</h4>
