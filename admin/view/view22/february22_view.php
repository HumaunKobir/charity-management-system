...
<?php
    $sqli="SELECT * FROM found_tb Where years='2022' AND month_n='February'";
    $result=mysqli_query($conn, $sqli);
    $query ="SELECT SUM(money_d) AS total_add FROM found_tb Where years='2022' AND month_n='February'";
    $query_result = mysqli_query($conn,$query);
  
?>
 
 <div class="mt-3">
 <h4>ফেব্রুয়ারী ২০২২ আয় সমূহ</h4>
