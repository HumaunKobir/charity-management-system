<?php 
    ...
    class adminLog{
        ...
        {
            $dbhost = 'sql107.ezyro.com';
            $dbuser = 'ezyro_32404283';
            $dbpass = 'mk&12345';
            $dbname = 'ezyro_32404283_charity';
        ...
        public function display_post_public(){
            $dis_posts="SELECT * FROM post_etc Where post_status=1 ORDER BY id DESC";
